    ...
    <div class="container-fluid sfondoServizi vh-100">
        <div class="row justify-content-center">
            <div class="col-12 text-center mt-3">
                <h1 class="primario marginTop textShadow3">Registrati</h1>
                <div class="text-center">
                    <p class="primario textShadow3">Hai già un account? <a class="text-decoration-none terziario" href="{{ route('login') }}">Accedi!</a></p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <form method="POST" action="{{ route('register') }}">
                    @csrf
                <div class="mb-3">
                    <label for="user-name" class="form-label primario textShadow3">Nome Utente</label>
                ...
                <div class="mb-3">
                    <label for="password-confirmation" class="form-label primario textShadow3">Conferma Password</label>
