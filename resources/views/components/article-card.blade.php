<div class="container-fluid card mx-auto card-w text-center sfondoCard cardDimension cards article-card">
    ...
    <div class="row justify-content-center align-items-center text-center">
        ...
        <img src="{{ $article->images->isNotEmpty() ? $article->images->first()->getUrl(300, 300) : 'https://picsum.photos/300' }}" alt="immagine placeholder" class="card-img-top img-fluid rounded-5">
